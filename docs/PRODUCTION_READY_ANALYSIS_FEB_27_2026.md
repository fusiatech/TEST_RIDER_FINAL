# SwarmUI - Production-Ready Repository Analysis
## February 27, 2026
...
| Frontend/UI | 70+ components | ~12,000+ | ✅ Production-Ready |
...
| `file-tree.tsx` | 471 | Recursive tree, context menus, inline rename, create/delete | File management |
...
| Component | Lines | Features | Evidence |
|-----------|-------|----------|----------|
| `testing-dashboard.tsx` | 2,028 | Test execution, coverage, trends, comparison, error analysis | Full testing UI |
...
|------|-------|----------|----------|
| `lib/store.ts` | 1,831 | 40+ state slices, 50+ actions, WebSocket integration | Zustand store |
...
|---------|------|-------|--------|
| Spell Checker | `spell-check-input.tsx` | 320 | ✅ Integrated |
| Voice Input | `voice-input-button.tsx` | 294 | ✅ Integrated |
...
| `security-checks.ts` | 419 | SAST/audit/secret scanning | ✅ |
| `secrets-scanner.ts` | 412 | 20 secret patterns detection | ✅ |
| `github-integration.ts` | ~200 | GitHub CLI wrapper (20+ functions) | ✅ |
| `anti-hallucination.ts` | 374 | Output validation | ✅ |
| `confidence.ts` | 322 | Jaccard + semantic scoring | ✅ |
| `ws-server.ts` | 284 | WebSocket message handling | ✅ |
| `evidence.ts` | 253 | Evidence ledger | ✅ |
| `cli-runner.ts` | 249 | CLI process spawning | ✅ |
| `cli-detect.ts` | 199 | CLI detection (7 providers) | ✅ |
| `scheduler.ts` | 193 | Cron-like scheduling | ✅ |
| `extension-manager.ts` | ~1,000 | Extension lifecycle + URL install | ✅ |
...
| Health & Metrics | 4 | ✅ |
| Files, Jobs, Scheduler, Sessions, Settings | 30 | ✅ |
...
### Grafana Dashboard
- Pre-configured SwarmUI dashboard
...
|-------------|--------|----------|
| GitHub | ✅ Complete | 20+ functions in `github-integration.ts` |
...
| Schema validation | 62 Zod schemas | ✅ |
...
| GitHub integration | 20+ functions | ✅ |
